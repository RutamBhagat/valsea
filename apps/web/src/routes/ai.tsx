...
import { Bubble, BubbleContent } from "@valsea/ui/components/bubble";
...
import {
  ...
  EmptyMedia,
  EmptyTitle,
} from "@valsea/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@valsea/ui/components/input-group";
import {
  Message,
  MessageContent as MessageBody,
  MessageHeader,
} from "@valsea/ui/components/message";
import {
  MessageScroller,
...
} from "@valsea/ui/components/message-scroller";
import { Tooltip, TooltipContent, TooltipTrigger } from "@valsea/ui/components/tooltip";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, valsea!</EmptyTitle>
